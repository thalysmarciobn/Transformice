package com.transformice.network.server.messages.incoming.chat;
...
public class Command extends MessageHandler {
    ...
    public void handle() {
        ...
        if (this.client.gameManage.commandManage.commands.containsKey(command)) {
            com.transformice.server.users.commands.Command _command = this.client.gameManage.commandManage.commands.get(command);
